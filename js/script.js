...
var email = document.querySelector("input[type=email]"); // events
// show modal
...
modalOpen.addEventListener("click", function (event) {
	...
	document.querySelector(".modal").classList.add("fadeIn"); // remove animation fadeIn
...
form.addEventListener("submit", function (event) {
	event.preventDefault(); // if field is empty

	if (email.value === "") {
		// show error
		email.classList.add("modal-form__input_error"); // add animation shake

		document.querySelector(".modal").classList.add("snake"); // remove animation shake and error
